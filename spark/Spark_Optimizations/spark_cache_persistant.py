...
Notes:
    ...
    - we should not cache the large dataframe because it may not be fit in memory, so we can cache the medium level data frames which can easily fit into memory
